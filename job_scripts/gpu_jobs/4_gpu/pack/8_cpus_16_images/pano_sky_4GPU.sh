...
#PBS -N PANO_TEST
#PBS -q v100@pbspl4
#PBS -l select=8:model=sky_gpu:ncpus=1:ngpus=1:ompthreads=1:mem=64GB
...
mpiexec -n 8 ./pano_sky_object --match_conf 0.3f --conf_thresh 0.3 --blend no --blend_strength 0 --try_cuda yes --expos_comp no --warp plane --wave_correct no  --features surf --match_conf 0.3
